...
type AnalyticsRepository interface {
	...
	OrphanAssignees(ctx context.Context) ([]domain.OrphanAssignee, error)
}
...
func (s *Analytics) TeamStats(ctx context.Context, actorID int64) ([]domain.TeamStats, error) {
...
func (s *Analytics) TopCreators(ctx context.Context, actorID int64) ([]domain.TeamTopCreator, error) {
	if err := s.authz.RequireAdmin(ctx, actorID); err != nil {
		return nil, err
	}
	creators, err := s.repo.TopCreators(ctx)
	if err != nil {
...
func (s *Analytics) OrphanAssignees(ctx context.Context, actorID int64) ([]domain.OrphanAssignee, error) {
	if err := s.authz.RequireAdmin(ctx, actorID); err != nil {
		return nil, err
	}
	orphans, err := s.repo.OrphanAssignees(ctx)
	if err != nil {
